...
import cn.catguild.auth.api.dto.type.MenuMeta;
...
@ToString
@Data
public class MenuTreeResponse implements CatTreeNode<MenuTreeResponse,Long> {
	...
	private Collection<MenuTreeResponse> children;
