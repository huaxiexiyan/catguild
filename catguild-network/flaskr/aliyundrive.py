...
import requests
import datetime
from flaskr.aliyundrive_info import AliyundriveInfo
...
class Aliyundrive:
    ...
    def _get_access_token(self, token: str) -> tuple[bool, str, str, str]:
        ...
        :return:  tuple[0]: 是否成功请求token
                  ...
                  tuple[3]: message
        """
        app.logger.info('根据refresh_token获取access_token')
